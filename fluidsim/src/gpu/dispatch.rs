...
impl GpuSimulation {
    ...
    pub fn record_step_frame(&mut self, cmd: vk::CommandBuffer, params: StepFrameParams) {
        ...
        // `substeps >= 1` is guaranteed by the early return above.
        let reaction_substep_dt = reaction_dt / substeps as f32;
        ...
        for _ in 0..substeps {
            ...
            // Diffusion wrote into the other ping-pong buffer; make it current
            // and fence its writes before the charge-projection pass reads them.
