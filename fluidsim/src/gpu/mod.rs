...
// Fixed GPU buffer capacities. Each storage buffer is sized for the maximum,
// and uploads bail out if the caller exceeds these limits.
...
/// A Vulkan buffer paired with its backing allocation and byte size.
