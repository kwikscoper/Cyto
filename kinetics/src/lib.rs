...
//! - `engine`: The main `KineticsEngine` API and `RuleEvaluator` trait
//! - `noop`: No-op evaluator used when rule evaluation is disabled
//! - `lean_bridge`: Subprocess bridge that drives the Lean `cyto-rules` binary
//! - `lean_evaluator`: `RuleEvaluator` that serializes snapshots to/from Lean
