...
use crate::app_types::{PerformanceSample, RenderFrameMetrics, duration_millis_f32};
        ...
        match event {
            ...
            WindowEvent::RedrawRequested => {
                ...
                self.push_performance_sample(PerformanceSample {
                    timestamp: t4,
                    frame_ms: duration_millis_f32(t4 - frame_start),
                    simulation_ms: duration_millis_f32(t1 - t0),
                    tooltip_ms: duration_millis_f32(t2 - t1),
                    ui_ms: duration_millis_f32(t3 - t2),
